...
CREATE TABLE `xiaozhi`.`sys_device` (
  ...
  `configId` int DEFAULT NULL COMMENT '模型ID',
  `roleId` int unsigned DEFAULT NULL COMMENT '角色ID，主键',
  `ip` varchar(45) DEFAULT NULL COMMENT 'IP地址',
  `wifiName` varchar(100) DEFAULT NULL COMMENT 'WiFi名称',
  `chip_model_name` varchar(100) DEFAULT NULL COMMENT '芯片型号' AFTER `wifiName`,
  `version` varchar(50) DEFAULT NULL COMMENT '固件版本' AFTER `chip_model_name`;

...
public class SileroVadOnnxModel {
    ...
    public SileroVadOnnxModel(String modelPath) throws OrtException {
        ...
        // Set the IntraOp thread count to 1, IntraOp threads are used for parallel
    ...
    private ValidationResult validateInput(float[][] x, int sr) {
        ...
        // Process the input data when the sample rate is not equal to 16000 and is a
        // multiple of 16000
        ...
        // If the sample rate is not in the list of supported sample rates, throw an
        // exception

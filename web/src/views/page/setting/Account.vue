  ...
  data () {
    return {
      data: {
        columns: ['日期', '总数', '报名', '参加'],
        rows: [
          { 日期: '4/18', 总数: 1111, 报名: 1000, 参加: 900 },
          { 日期: '5/18', 总数: 2222, 报名: 1600, 参加: 987 },
          { 日期: '6/17', 总数: 2333, 报名: 1700, 参加: 1200 },
          { 日期: '7/17', 总数: 4444, 报名: 1600, 参加: 1300 },
          { 日期: '8/16', 总数: 5555, 报名: 1800, 参加: 1100 },
          { 日期: '9/18', 总数: 6666, 报名: 1500, 参加: 1450 }
        ]
      },
      user: {},
      // 遮罩层
